...
#echo "cleaning out $1 's old JAR files" <-- slows things down, so off normally
...
ssh winterwell@$1 'rm -rf /home/winterwell/as.good-loop.com/adunit/build/*'
...
echo ""
echo "Stop & Start the Adserver process"
